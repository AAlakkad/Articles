...
توفّر ووردبريس حلّاً سهلاً ومناسباً لهذه المشكلة، وذلك باستخدام دالّة [`wp_localize_script`](https://codex.wordpress.org/Function_Reference/wp_localize_script)، اسم الدالّة قد يوحي أنها مخصصة للترجمة، لكن يمكن استخدامها لتمرير جمل الترجمة وأي نوع آخر من المتغيّرات إلى جافاسكريبت.

محددات الدالّة هي:
- `$handle`: معرّف لملف جافاسكريبت الذي نريد تمرير المتغيّرات له، يجب أن يكون الملف مسجّلاً قبل استخدام الدالّة. 
- `$name`: اسم متغيّر جافاسكريبت الذي سيتم وضع البيانات بداخله.
- `$data`: مصفوفة المتغيّرات التي نريد تمريرها إلى جافاسكريب.
